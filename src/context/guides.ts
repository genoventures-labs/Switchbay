...
const BUILTIN_GUIDES: Guide[] = [
  ...
  },
  {
    ...
    title: "LM Studio MCP Quick Start",
    description: "How Bay should handle local MCP lane setup and failures.",
    kind: "quickstart",
    ...
    body: [
      ...
      "- LM Studio itself must have the matching MCP server installed and enabled.",
      "- Missing plugin handle errors usually mean the integration id exists in Switchbay config but not in LM Studio.",
    ].join("\n"),
  },
  {
